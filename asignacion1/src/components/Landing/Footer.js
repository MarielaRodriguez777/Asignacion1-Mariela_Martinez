    ...
    return (
        <div>
            <footer>
                ...
                <div>
                    <p><i className="fas fa-phone"></i> Phone: +50422202220</p>
                    <p><i className="fas fa-envelope-open-text"></i>    Email: makeup@gmail.com</p>
                    <p><i className="fas fa-address-card"></i>  Address: Lomas del Guijarro</p>
                    <p><i className="fas fa-table"></i> Date</p>
                </div>
                <div>
                    <p><i className="fas fa-copyright"></i> All rights reserved</p>
                </div>
                <div>
                    <div className="size">
                        <span>
